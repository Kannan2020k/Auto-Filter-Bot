...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002121955000').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001935178500'))
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001935178500'))
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001935178500'))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
AUTH_CHANNELS = [int(ch) for ch in environ.get("AUTH_CHANNELS", "-1002121955000").split() if ch and id_pattern.match(ch)]
AUTH_REQ_CHANNELS = [int(ch) for ch in environ.get("AUTH_REQ_CHANNELS", "").split() if ch and id_pattern.match(ch)]
REQST_CHANNEL = int(ch) if (ch := environ.get("REQST_CHANNEL", "-1003759672280")) and id_pattern.search(ch) else None
SUPPORT_CHAT_ID = int(ch) if (ch := environ.get("SUPPORT_CHAT_ID", "")) and id_pattern.search(ch) else None

OWNER = int(os.environ.get("OWNER", "5211097531"))
CHANNEL_LINK = environ.get('CHANNEL_LINK', 'https://t.me/+wEULR-LArGc3OGY1')
...
UPDATE_CHANNEL = int(environ.get('UPDATE_CHANNEL', '-1002121955000'))
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001935178500'))
VERIFY_IMG = environ.get("VERIFY_IMG", "https://i.ibb.co/xqNtSMpS/photo-2025-09-18-15-24-38-7551450511015149572.jpg")
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Fast_Download2k/4")
